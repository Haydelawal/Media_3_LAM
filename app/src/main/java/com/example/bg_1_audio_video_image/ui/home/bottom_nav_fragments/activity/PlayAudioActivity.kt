...
@AndroidEntryPoint
class PlayAudioActivity : AppCompatActivity(), Player.Listener {
    ...
    private val mediaItem by lazy {
        ...
        MediaItem.Builder()
            .setUri(args.audioData.media_url)
            .setMediaId(args.audioData.id.toString())
            .setMediaMetadata(
                MediaMetadata.Builder()
                    .setTitle(args.audioData.title)
                    .build()
            )
            .build()
    }
...
//        binding = ActivityPlayAudioBinding.inflate(layoutInflater)
        ...
        binding.viewOffline.setOnClickListener {
            if (downloadTracker?.isDownloaded(mediaItem) == true) {
                startActivity(OfflinePlayerActivity.getIntent(this))
            } else {
                Toast.makeText(this, "Audio Not Downloaded yet", Toast.LENGTH_SHORT).show()
            }
        }
    }
...
//            val stateString: String =
                ...
                ExoPlayer.STATE_IDLE -> {
                    val builder = AlertDialog.Builder(this@PlayAudioActivity)
